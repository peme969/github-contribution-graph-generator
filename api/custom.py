...
def build_svg(
    ...
    svg_parts.append(
        ...
        # ----------------------------
    # INSIDE FOOTER (bottom-right inside card)
    # Opposite side of the legend (legend is left)
    # ----------------------------
    inside_footer_x = CARD_X + card_width - 8
    inside_footer_y = legend_y
    
    # First line: "Generated by my repo"
    svg_parts.append(
        f'<text x="{inside_footer_x}" y="{inside_footer_y - 12}" '
        f'text-anchor="end" '
        f'font-family="{FONT_FAMILY}" font-size="12" fill="#8b949e">'
        f'{repo_label}</text>'
    )
    
    # Second line: clickable repo link (displayed text)
    svg_parts.append(
